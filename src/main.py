...
layout.btn_select_bg.grid(column=0, row=0, sticky="WE")
layout.entry_bg_path.grid(column=1, row=0)
layout.entry_bg_path.xview(len(layout.strvar_bg_path.get()))
layout.btn_select_fg.grid(column=0, row=1, sticky="WE")
layout.entry_fg_path.grid(column=1, row=1)
layout.entry_fg_path.xview(len(layout.strvar_fg_path.get()))
...
layout.btn_superimpose.grid(column=0, row=6, sticky="EW")
layout.label_bg_indicator.grid(column=0, row=4)
layout.label_fg_indicator.grid(column=1, row=4)
layout.label_fg_display.grid(column=1, row=5)
layout.label_bg_display.grid(column=0, row=5)
layout.label_finalimg_display.grid(column=0, row=7, columnspan=8)
layout.btn_save.grid(column=0, row=8, sticky="WE")
layout.btn_exit.grid(column=1, row=8, sticky="EW")
